...
def calculate_demographic_data(print_data=True):
    ...
    higher_education = df.loc[df['education'].isin(['Bachelors', 'Doctorate', 'Masters'])]
    lower_education = df.loc[~df['education'].isin(['Bachelors', 'Doctorate', 'Masters'])]
    ...
    for country, income in df.groupby('native-country'):
      perc = (income['salary'] == '>50K').sum() / len(income['salary'])
      country = country
